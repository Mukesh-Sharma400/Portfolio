        ...
        <div className="col">
          <div className="card shadow h-100 rounded-3">
            ...
            <div className="card-body">
              <p>
                During the intern period I got to learn how should one approach
                a complex problem and what all steps are required for a MERN
                Stack application building. In the internship period I performed
                several tasks like making a MERN Stack application responsive
                for all devices, integrating a chat bot and a community section.
              </p>
            </div>
          ...
          <div className="card shadow h-100 rounded-3">
            ...
            <div className="card-body">
              <p>
                ...
                Application using MERN Stack under the guidance of Yougetplaced
                via NullClass.
              </p>
            </div>
            <div className="card-footer">
